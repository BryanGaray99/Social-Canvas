...
@Component({
  selector: 'app-fb-canvas',
  templateUrl: './fb-canvas.component.html',
  styleUrls: ['./fb-canvas.component.css'],
})
export class FbCanvasComponent implements OnInit {
  ...
  private loadSelectedUsersFromLocalStorage(): void {
    const selectedUsersData = localStorage.getItem('selectedUsers-fb');
  ...
  private saveSelectedUsersToLocalStorage(): void {
    localStorage.setItem('selectedUsers-fb', JSON.stringify(this.selectedUsers));
  }
}